document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      let isValid = true;
      const fieldsToValidate = contactForm.querySelectorAll('input, textarea, select');
  ...
  const animatableElements = document.querySelectorAll(animationClasses.join(', '));
  ...
  if (animatableElements.length > 0) {
    animatableElements.forEach(function (el) {
      ...
      if (elClass.includes('fade-in-up') || elClass.includes('slide-up')) {
        el.style.transform = 'translateY(30px)';
      } else if (elClass.includes('fade-in-down')) {
        el.style.transform = 'translateY(-30px)';
      } else if (elClass.includes('fade-in-left') || elClass.includes('slide-in-left')) {
        el.style.transform = 'translateX(-30px)';
      } else if (elClass.includes('fade-in-right') || elClass.includes('slide-in-right')) {
        el.style.transform = 'translateX(30px)';
      }
    });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "PosturePro uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '46bc2c67-5444-495c-9fcc-e300548330a7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '46bc2c67-5444-495c-9fcc-e300548330a7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '46bc2c67-5444-495c-9fcc-e300548330a7';
